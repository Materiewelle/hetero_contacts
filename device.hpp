...
namespace d {
    ...
    static constexpr double m_eff = 0.08 * c::m_e;                                // effective mass
    ...
    static constexpr double lam_g = 4;//sqrt(eps_g*d_g*d_g/8/eps_o*log(1+2*d_o/d_g)); // scr. length in channel
    static constexpr double lam_s = 2;//lam_g;//1.0 < lam_g ? 1.0 : lam_g;                    // scr. length in source
    static constexpr double lam_d = 2;//lam_g;//1.0 < lam_g ? 1.0 : lam_g;                    // scr. length in drain
    ...
    static constexpr double E_min = -1.8;
    static constexpr double E_max = +1.8;
